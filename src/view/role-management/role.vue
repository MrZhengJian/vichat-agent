...
export default {
  ...
  data () {
    ...
    return {
      accessList:{
          "role_del":this.$store.state.user.funcObj.role_del||false,
          "role_assign":this.$store.state.user.funcObj.role_assign||false,
          "role_edit":this.$store.state.user.funcObj.role_edit||false,
          "role_add":this.$store.state.user.funcObj.role_add||false
      },
      tableData:[],
      saveTableData:[],
      searchText:'',
            ...
            render: (h, params) => {
                return h('div', [
                  h('Button',{
                        ...
                        style:{
                            display:this.accessList.role_edit?'inline-block':'none',
                            marginRight:'10px',
                            cursor:'pointer',
                            color:'#2DB7F5'
                        },
                    ...
                    h('Button',{
                        ...
                        style:{
                            display:this.accessList.role_assign?'inline-block':'none',
                            marginRight:'10px',
                            cursor:'pointer',
                            color:'#2DB7F5'
                        },
                    ...
                    h('Button', {
                        ...
                        style:{
                          display:this.accessList.role_del?'inline-block':'none',
                          cursor:'pointer',
                          marginRight:'10px',
                          color:'#F25E43'
                        },
  ...
  methods: {
    ...
    sendRole(){
      ...
      .then(res=>{
        if(res.data.code==0){
          if(_this.roleForm.roid==0)  _this.$Message.success(_this.$t('channel_addChannel_ok'))
