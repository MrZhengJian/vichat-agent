    ...
    <div class="orgTable">
        ...
        <Modal @on-visible-change="show=false" :title="org_table_modal2_title" v-model="modal2" class="addorg">
            <Form ref="form1" :model="form" :rules="rule" :label-width="120">
                ...
                <org-tree v-show="show" :partyId='mypartyId' :updateTreeList="updateTreeList" v-on:changeOrg="changeOrg"></org-tree>
    		    </Form>
            <div slot="footer">
...
export default {
  ...
  methods: {
              ...
              .then(function (res) {
                if (res.data.code==0) {
                  ...
                  orgZTree({partyId:_this.mypartyId}).then(res=>{
                    _this.updateTreeList = res.data.data
                  })
    ...
    _deleteOrg () {
      ...
      delOrg({'orgId': id,'partyId':this.mypartyId})
        .then(function (res) {
          if (res.data.code==0) {
            _this.modal3 = false
