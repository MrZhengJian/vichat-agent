...
<template>
	<div class="table">
		<p class="btn-group">
            <Button type="primary" v-if="accessList.company_account_export" @click="exportData">{{$t('user_table_btn_export')}}</Button>
            ...
            <Button type="primary" v-if="accessList.company_account_add" @click="openAddUser">{{$t('user_table_btn_add')}}</Button>
